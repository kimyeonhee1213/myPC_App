      ...
      <ul class="nav navbar-nav">
        ...
        <li>
         <div class="btn-group" role="group" aria-label="Basic example">
		  <button class="btn btn-info" onclick="location.href='/myPC_App/tip/clean.jsp'">청소 꿀팁</button>
		  <button class="btn btn-info" onclick="location.href='/myPC_App/tip/arrangement.jsp'">정리 꿀팁</button>
		  <button class="btn btn-info" onclick="location.href='/myPC_App/tip/wash.jsp'">빨래 꿀팁</button>
		  <button class="btn btn-info" onclick="location.href='/myPC_App/tip/eat.jsp'">집밥 꿀팁</button>
		</div>
        </li>
      </ul>
